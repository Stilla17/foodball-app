    ...
    <div className="sticky bg-[#F6F6F4] w-64">
      <div className="text-black pl-8 py-8">
        ...
        <div className="flex my-5 gap-4 nav-main hover:text-[#F5C451] cursor-pointer transition-[0.4s]">
          ...
          <p className="hover:text-[#F5C451]">{t("football")}</p>
        </div>
