    ...
    return (
        <div className='sticky bg-[#F6F6F4] w-64'>
            <div className='text-black pl-8 py-8'>
                ...
                <div className='flex pt-4 gap-4 nav-main hover:text-[#F5C451] cursor-pointer'>
                ...
                <div className='flex my-5 gap-4 nav-main hover:text-[#F5C451] cursor-pointer'>
                ...
                <div className='flex gap-4 nav-main hover:text-[#F5C451] cursor-pointer'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                ...
                <div className='flex gap-4 my-5 nav-main hover:text-[#F5C451] cursor-pointer'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                ...
                <div className='flex gap-4 py-5 nav-main hover:text-[#F5C451] cursor-pointer'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
